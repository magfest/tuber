...
def upgrade():
    ...
    op.execute('update room_night_approval set badge = rnr.badge from room_night_approval as rna inner join room_night_request as rnr on rna.room_night = rnr.id')
